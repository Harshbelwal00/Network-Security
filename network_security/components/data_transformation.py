...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        it initialises a KNN imputer object with the parameter specified in it training_pipeline.py
        file and return a pipeline object with the KNN imputer as the first step 
        """
        logging.info("Entered get_data_transformer_object method of Transformation class")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"Intializing KNNImputer with{DATA_TRANSFORMATION_IMPUTER_PARAMS}")
